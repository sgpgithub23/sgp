    ...
    <div className={styles.main}>
      ...
      >
        <div
          ...
          style={{ backgroundColor: `${bluredred}` }}
        ></div>
        <div className={styles.headerContent}>
          <div className={styles.left}>
            <div className={styles.mainTitle}>
              ...
              <h2>
                {" "}
                <strong>Decisões Conscientes, Empresas Resilientes: </strong>
                <em>
          ...
          <div className={styles.center}>
            <div>
              <p>
                Uma obra que veio para revolucionar o mercado empresarial, bem
                como todo o Poder Público, que busca com cada vez mais
                intensidade uma Administração Gerencial eficiente, moderna e
                eficaz.
              </p>
            </div>
      ...
      <div className={styles.pageSize}>
        <div className={styles.infoProduto}>
          ...
          <hr
            style={{ backgroundColor: `${red1}`, border: `1px solid ${red1}` }}
          />
          <div>
            <p>
              “No mundo contemporâneo, a boa governança é fundamental para
              garantir a sustentabilidade organizacional. Dentro desse contexto,
              a obra de Humberto Mota Filho, pelo seu pioneirismo, constitui
              leitura obrigatória para executivos, advogados, pesquisadores,
              estudantes e profissionais de diversas áreas do pensamento
              científico que desejam adotar uma postura mais moderna e
              proativa”. Marcelo Zenkner, Ex-Diretor de Governança e
              Conformidade da Petrobras
            </p>
            <p>
              “O autor nos oferece uma importante contribuição para que o futuro
              da nossa sociedade seja encarado com esperança de melhores dias.
              Seu livro amarra bem a estrutura que as empresas devem construir
              em torno dos seus sistemas de gestão e governança, atuando com
              respeito às disposições do compliance”. José Luiz Alquéres,
              Ex-Presidente da Associação Comercial do Rio de Janeiro.
              Conselheiro do Centro Brasileiro para o Desenvolvimento
              Sustentável{" "}
            </p>
            <p>
              “Profundo estudioso do tema, o autor nos convida a uma reflexão
              propositiva de como os setores público e privado podem atuar na
              construção de um ambiente íntegro. Decisões Conscientes, Empresas
              Resilientes, obra fluida, com vasta fundamentação teórica, amplia
              a visão do leitor de como a integridade pode aprimorar a tomada de
              decisões e impactar na longevidade das organizações”. Suzana
              Fagundes Ribeiro de Oliveira, Diretora Jurídica e de Relações
              Institucionais da Localiza
            </p>
            <p>
              “O livro do Prof. Mota Filho, além de muito consistente, é
              extremamente oportuno. O autor, com sua múltipla formação
              (direito, economia e ciência política), nos brinda com um
              instrumental rico e moderno que, certamente, vai contribuir em
              muito para a modernização das empresas brasileiras”. Prof. Dr.
              Geraldo Tadeu Moreira Monteiro, Diretor do Centro Brasileiro de
              Estudo e Pesquisas sobre a Democracia - CEBRAD/UERJ
            </p>
            <p>
              “Humberto Mota Filho vem se revelando como uma liderança
              consciente, imprescindível. Um incansável missionário. Nesse livro
              nos estimula a refletir, além da superficialidade, tão comum,
              hoje”. Prof. Francisco Gomes de Matos, Autor do livro Cultura de
              Liderança, Carismas e Parábolas Corporativas
            </p>
          </div>
        </div>
      </div>
