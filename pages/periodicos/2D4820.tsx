  ...
  return (
    <div className={styles.main}>
      ...
      <section className={styles.content}  style={{backgroundColor: `#${color}`}} >
        <div className={styles.bluredBall} style={{backgroundColor: `${bluredGreen}`}}></div>
        <div className={styles.headerContent}>
          <div className={styles.left}>
            <div className={styles.mainTitle}>
              <hr style={{backgroundColor: `${green2}`, marginBlock: "10px", border: `1px solid ${green2}`}} />
              <h2> <strong>Agenda 2030 - Direito e Desenvolvimento Sustentável</strong>: <em>governança, sociedade e meio ambiente</em> </h2>
            </div>
          </div>
          <div className={styles.center}>
            <div>
              <p>Conheça as principais questões da Agenda de Sustentabilidade do séc. XXI, em função do Acordo de Paris (2015) e da Agenda 2030 da Resolução da ONU, tratando das 17 metas dos Objetivos de Desenvolvimento Sustentável (ODS).</p>
            </div>
            <div className={styles.precobtn}>
              <Button color="blue" title="Saiba mais" style={{backgroundColor: `${green2}`}} />
              <div>
                <p>R$ 99,00 <br /> (com frente incluso)</p>
              </div>
            </div>
      ...
      <div className={styles.pageSize}>
        <div className={styles.infoProduto}>
          ...
          <hr style={{backgroundColor: `${green2}`, border: `1px solid ${green2}`}}/>
          <div>
            <p>Com o Prefácio do Professor Paulo de Bessa Antunes, esta obra apresenta um conteúdo inovador, que, de forma preliminar, é apresentado como contribuição no debate referente à Agenda 2030, um tema vital para a mudança de paradigma, que a humanidade precisa no âmbito do combate às mudanças climáticas e da transição energética indispensável para as futuras gerações.</p>
            <p><b>Organização: </b>Organização: Humberto Eustáquio César Mota Filho, Vanessa Cerqueira Reis de Carvalho e José Francisco Lumango.</p>
            <p><b>Autores: </b> Carolina Gladyer Rabelo Saches, Gabriela Alves Mendes Blanchet, Humberto Eustáquio César Mota Filho, Kátia Santos, José Francisco Lumango, Renata Andrade Vilarinho, Tatiana Bastos e Vanessa Cerqueira Reis de Carvalho.</p>
          </div>
        </div>
      </div>
      ...
      <section className={styles.dadosPagamentoContato}>
        ...
        <form>
          ...
          <div className={styles.cienciaSobCompra}>
            ...
            <ul>
              <li><AiOutlineCheckCircle style={{color: `${green2}`}} /><span>Estou ciente e aceito a <b> Política de Cookies *</b></span></li>
              <li><AiOutlineCheckCircle style={{color: `${green2}`}} /><span>Estou ciente e aceito a <b>Política de Privacidade *</b></span></li>
              <li><AiOutlineCheckCircle style={{color: `${green2}`}} /><span>Estou ciente e aceito o <b>Termo de Consentimento da Privacidade *</b></span></li>
            </ul>
