    ...
    <div className={styles.main}>
      ...
      <div className={styles.content}>
        ...
        <div className={styles.headerContent}>
            ...
            <hr />
            <p>
                <b>A SGP Soluções</b> registra todos os momentos especiais para nunca esquecer que o mais importante sempre será você <b>nosso cliente</b>.
            </p>
            ...
            <div className={styles.introduction}>
                ...
                <div className={styles.right}>
                    <div className={styles.inputLupa}>
                        <HiMagnifyingGlass />
                        <Input withIcon placeholder="Pesquisar curso..." label="" type="text" />
                    </div>
                </div>
            </div>
            <div className={styles.cursosNovos}>
                {Cursos.map(({ objetivo, publicoalvo, title, cursoNovo }) => (
                    ...
                    <div>
                        <h4><b>{title}</b></h4>
                        <p role="button">
                            <span><BsPersonCircle /> Conferir detalhes</span>
                        </p>
                    </div>
                </div>
                ))}
            </div>
            <p>Confira a lista completa <b style={{cursor: "pointer"}}>clicando aqui!</b></p>
        </div>
    </div>
    ...
    <div className={styles.mainContentFormTreinamento}>
        <div className={styles.introduction}>
            <div className={styles.left}>
                ...
                <span>Conheça nossos treinamentos de excelência e gabarito, que aplicam e vivenciam as melhores boas práticas do mercado.</span>
            </div>
            <div className={styles.right}>
                <div className={styles.inputLupa}>
                    <HiMagnifyingGlass />
                    <Input withIcon placeholder="Pesquisar treinamento..." label="" type="text" />
                </div>
            </div>
        </div>
        <div className={styles.cursosNovos}>
