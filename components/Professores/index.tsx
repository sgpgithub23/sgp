  ...
  return (
      <div className={styles.mainContentForm}>
          ...
          <div className={styles.professoresTodos}> 
              {professores.map((x, index) => (
                  <div key={index} className={styles.professor} >
                    <Image priority style={{maxWidth: "100%", height: "auto"}} src={x.img || "https://pbs.twimg.com/profile_images/956910864698953730/FDAqZ5hv_400x400.jpg"} alt={"Professor(a) - " + x.nome} width={294} height={362} />
          ...
          <Transition appear show={isModalOpen} as={Fragment}>
            <Dialog as="div" style={{zIndex: 50}} onClose={() => setIsModalOpen(false)}>
